...
def call_claude_api(system_prompt: str, user_prompt: str, skill_name: str) -> str:
    ...
    Lève une SystemExit en cas d'erreur API.
    """
    ...
    try:
        ...
        log_error("Rate limit Anthropic atteint — attendez quelques secondes et relancez")
        sys.exit(1)

    except anthropic.APIConnectionError as e:
        log_error(f"Connexion à l'API Anthropic impossible : {e}")
        sys.exit(1)
